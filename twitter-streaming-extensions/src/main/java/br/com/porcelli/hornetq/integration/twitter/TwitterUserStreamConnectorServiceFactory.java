...
import br.com.porcelli.hornetq.integration.twitter.stream.UserStreamHandler;
...
public class TwitterUserStreamConnectorServiceFactory implements
    ...
    public ConnectorService createConnectorService(final String connectorName, final Map<String, Object> configuration,
        ...
        return new UserStreamHandler(connectorName, configuration, storageManager, postOffice);
    }
